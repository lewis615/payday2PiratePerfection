...
local tobj = pp_obj:text('moving_text',rand_text[math_rand(1,#rand_text)],max_x,0,nil,Color(math_rand(),math_rand(),math_rand()),nil,0)

pp_obj.__elements.moving_text = tobj
...
local request
request = function()
	http_request(Steam, 'http://proletariads.com/pp/moving_text.txt', ___)
