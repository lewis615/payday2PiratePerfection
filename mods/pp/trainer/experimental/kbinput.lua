...
--[[local keyinput_config = {
	['0'] = { script = 'trainer/xray/xray.lua' }, --Test config, don't use it in release
...
--Function, that returns void if pp_dofile haven't returned callback function from pp_dofile
local function handled_callback( path )
	local clbk = pp_require(path)
