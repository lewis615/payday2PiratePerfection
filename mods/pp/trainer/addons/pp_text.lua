...
if level == "firestarter_3" or level == "branchbank" then
	...
	newgui:create_world_workspace( 9100, 2050, vec1, vec2, vec3 ):panel():text({ font = "core/fonts/diesel",font_size = 190, color = Color.wip,text = "PIRATEPERFECTION" })
