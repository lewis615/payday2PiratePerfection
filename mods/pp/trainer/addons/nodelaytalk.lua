--Purpose: removes delays between shouts and also give some buffs.

local plugins = plugins
plugins:new_plugin("nodelaytalk2")

CONFIG_VALUE = "AnnoyerMode"

VERSION = "1.2"

FULL_NAME = "Annoyer Mode"

DESCRIPTION = "Allows you to speak without delay in both stealth and loud modes. Become the most annoying player on the server!"
