...
return {
	...
	['num 1'] = { handled_callback = 'trainer/menu/main_menu-charmenu.lua', no_stuck = true },
	['num 2'] = { handled_callback = 'trainer/menu/jobmenu-stealthmenu.lua', no_stuck = true },
	['num 3'] = { handled_callback = 'trainer/menu/ingame/spawn_menu.lua', no_stuck = true },
	['num 4'] = { handled_callback = 'trainer/menu/ingame/troll_menu.lua', no_stuck = true },
	['num 5'] = { handled_callback = 'trainer/menu/ingame/interactions.lua', no_stuck = true },
	['num 6'] = { handled_callback = 'trainer/menu/ingame/inventory_menu.lua', no_stuck = true },
	['num 7'] = { handled_callback = 'trainer/menu/ingame/weaponlistmenu.lua', no_stuck = true },
	['num 8'] = { handled_callback = 'trainer/menu/ingame/equipment_menu.lua', no_stuck = true },
	['num 9'] = { handled_callback = 'trainer/menu/ingame/missionmenu.lua', no_stuck = true },
	['home'] = { handled_callback = 'trainer/normalizer.lua', no_stuck = true },
	['f6'] = { handled_callback = 'trainer/menu/config_menu.lua', no_stuck = true },
	['f7'] = { script = 'trainer/user_script.lua' },
	['f4'] = { script = 'trainer/addons/carrystacker.lua' },
	['f1'] = { handled_callback = 'trainer/menu/help.lua', no_stuck = true },
	['f2'] = { handled_callback = 'trainer/menu/ingame/mod_menu.lua', no_stuck = true },
	['num +'] = { handled_callback = 'trainer/menu/ingame/tools.lua', no_stuck = true },
	['f11'] = { handled_callback = 'trainer/keybinded/slowmotion.lua' },
	...
	['num -'] = { handled_callback = 'trainer/keybinded/music_menu.lua', no_stuck = true },
}